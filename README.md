...
---
### 💼 Experiencia
- **Desarrollador Web — E2outlook**  
  Desarrollo de sitios web desde cero con WordPress y Divi.
- **Desarrollador Web — Blissout**  
  Desarrollo de sitios basados en propuestas del equipo UX/UI.
- **Desarrollador Web — Estudio PRONET OL**  
  Desarrollo de sitios en WordPress y Elementor.
- **Desarrollador Web — BlaBla! Marketing**  
  Desarrollo de temas para WordPress.
- **Desarrollador Web — Elephant Digital**  
...
- Linux y SQL aplicado a ciberseguridad
- Detección y respuesta ante incidentes
- Automatizacion de tareas de ciberseguridad con Python
...
- Email: `gustavoepr1110vv@gmail.com`
